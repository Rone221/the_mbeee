import RollingGallery from "../components/framer/RollingGallery";
const Home = () => {
  return (
    <>
      {" "}
          ...
          <div className="grid max-w-screen-xl px-4 py-12 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12">
            <div className="mr-auto place-self-center lg:col-span-7">
              ...
              <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                Suivez vos bétails, transactions et paniers en temps réel grâce
                à notre interface intuitive et moderne.
              </p>
              <a
                href="#"
